...
countries['Sudamérica'] = 'Chile|Argentina|Bolivia|Brazil|Colombia|Ecuador|Guyana|Paraguay|Peru|Suriname|Uruguay|Venezuela';
...
countries['Centroamérica'] = '|Belize|Costa Rica|El Salvador|Guatemala|Honduras|Nicaragua|Panama';
...
countries['Norteamérica'] = '|Bermuda|Canada|Greenland|Mexico|United States';
...
city_states['Chile'] = '|RM Santiago|XV Arica y Parinacota|I Tarapacá|II Antofagasta|III Atacama|IV Coquimbo|V Valparaíso|VI O\'higgins|VII Maule|VIII Bio-Bío|IX Araucanía|XIV Los Ríos|X Los Lagos|XI Aysén|XII Magallanes';
...
//CHILE
citys['XV Arica y Parinacota'] = '|Arica|Camarones|Putre|General Lagos';
citys['I Tarapacá'] = '|Iquique|Alto Hospicio|Pozo Almonte|Camiña|Colchane|Huara|Pica';
citys['II Antofagasta'] = '|Antofagasta|Mejillones|Sierra Gorda|Taltal|Calama|Ollagüe|San Pedro de Atacama|Tocopilla|María Elena';
citys['III Atacama'] = '|Copiapó|Caldera|Tierra Amarilla|Chañaral|Diego de Almagro|Vallenar|Alto del Carmen|Freirina';
citys['IV Coquimbo'] = '|La Serena|Coquimbo|Andacollo|La Higuera|Paiguano|Vicuña|Illapel|Canela|Los Vilos|Salamanca|Ovalle|Combarbalá|Monte Patria|Punitaqui|Río Hurtado';
citys['V Valparaíso'] = '|Valparaíso|Casablanca|Concón|Juan Fernández|Puchuncaví|Quintero|Viña del Mar|Isla de Pascua|Los Andes|Calle Larga|Rinconada|San Esteban|La Ligua|Cabildo|Papudo|Petorca|Zapallar|Quillota|Calera|Hijuelas|La Cruz|Nogales|San Antonio|Algarrobo|Cartagena|El Quisco|El Tabo|Santo Domingo|San Felipe|Catemu|Llaillay|Panquehue|Putaendo|Santa María|Limache|Quilpué|Villa Alemana|Olmué';
citys['VI O\'higgins'] = '|Rancagua|Codegua|Coinco|Coltauco|Doñihue|Graneros|Las Cabras|Machalí|Malloa|Mostazal|Olivar|Peumo|Pichidegua|Quinta de Tilcoco|Rengo|Requínoa|San Vicente|Pichilemu|La Estrella|Litueche|Marchihue|Navidad|Paredones|San Fernando|Chépica|Chimbarongo|Lolol|Nancagua|Palmilla|Peralillo|Placilla|Pumanque|Santa Cruz';
citys['VII Maule'] = '|Talca|Constitución|Curepto|Empedrado|Maule|Pelarco|Pencahue|Río Claro|San Clemente|San Rafael|Cauquenes|Chanco|Pelluhue|Curicó|Hualañé|Licantén|Molina|Rauco|Romeral|Sagrada Familia|Teno|Vichuquén|Linares|Colbún|Longaví|Parral|Retiro|San Javier|Villa Alegre|Yerbas Buenas';
citys['VIII Bio-Bio'] = '|Concepción|Coronel|Chiguayante|Florida|Hualqui|Lota|Penco|San Pedro de la Paz|Santa Juana|Talcahuano|Tomé|Hualpén|Lebu|Arauco|Cañete|Contulmo|Curanilahue|Los Alamos|Tirúa|Los Angeles|Antuco|Cabrero|Laja|Mulchén|Nacimiento|Negrete|Quilaco|Quilleco|San Rosendo|Santa Bárbara|Tucapel|Yumbel|Alto Biobío|Chillán|Bulnes|Cobquecura|Coelemu|Coihueco|Chillán Viejo|El Carmen|Ninhue|Ñiquén|Pemuco|Pinto|Portezuelo|Quillón|Quirihue|Ránquil|San Carlos|San Fabián|San Ignacio|San Nicolás|Treguaco|Yungay';
citys['IX Araucanía'] = '|Temuco|Carahue|Cunco|Curarrehue|Freire|Galvarino|Gorbea|Lautaro|Loncoche|Melipeuco|Nueva Imperial|Padre Las Casas|Perquenco|Pitrufquén|Pucón|Saavedra|Teodoro Schmidt|Toltén|Vilcún|Villarrica|Cholchol|Angol|Collipulli|Curacautín|Ercilla|Lonquimay|Los Sauces|Lumaco|Purén|Renaico|Traiguén|Victoria';
citys['XIV Los Ríos'] = '|Valdivia|Corral|Lanco|Los Lagos|Máfil|Mariquina|Paillaco|Panguipulli|La Unión|Futrono|Lago Ranco|Río Bueno';
...
citys['XI Aysén'] = '|Coyhaique|Lago Verde|Aisén|Cisnes|Guaitecas|Cochrane|O\'Higgins|Tortel|Chile Chico|Río Ibáñez';
citys['XII Magallanes'] = '|Punta Arenas|Laguna Blanca|Río Verde|San Gregorio|Cabo de Hornos|Antártica|Porvenir|Primavera|Timaukel|Natales|Torres del Paine';
citys['RM Santiago'] = '|Santiago|Cerrillos|Cerro Navia|Conchalí|El Bosque|Estación Central|Huechuraba|Independencia|La Cisterna|La Florida|La Granja|La Pintana|La Reina|Las Condes|Lo Barnechea|Lo Espejo|Lo Prado|Macul|Maipú|Ñuñoa|Pedro Aguirre Cerda|Peñalolén|Providencia|Pudahuel|Quilicura|Quinta Normal|Recoleta|Renca|San Joaquín|San Miguel|San Ramón|Vitacura|Puente Alto|Pirque|San José de Maipo|Colina|Lampa|Tiltil|San Bernardo|Buin|Calera de Tango|Paine|Melipilla|Alhué|Curacaví|María Pinto|San Pedro|Talagante|El Monte|Isla de Maipo|Padre Hurtado|Peñaflor';
...
function set_country(oRegionSel, oCountrySel, oCity_StateSel)
{
	...
	if (countries[region])
	{
		...
		oCountrySel.options[0] = new Option('SELECCIONE PAIS','');
...
function set_city_state(oCountrySel, oCity_StateSel, oCitys_Sel)
{
	...
	if (city_states[country])
	{
		...
		oCitys_Sel.disabled = true;
		oCity_StateSel.options[0] = new Option('SELECCIONE REGIÓN/ESTADO','');
...
function set_city(oCountrySel, oCity_StateSel, oCitys_Sel)
{
	...
	var country = oCountrySel.options[oCountrySel.selectedIndex].text;
	if (citys[city_state] && country == "Chile"){
		oCitys_Sel.disabled = false;
		document.getElementById('cityGroup').style.display = "block";
		oCitys_Sel.options[0] = new Option('SELECCIONE CIUDAD','');
		citys_Arr = citys[city_state].split('|');
		for (var i = 0; i < citys_Arr.length; i++)
			oCitys_Sel.options[i+1] = new Option(citys_Arr[i],citys_Arr[i]);
...
{
	var city_state = oCity_StateSel.options[oCity_StateSel.selectedIndex].text;
	var city = oCitys_Sel.options[oCitys_Sel.selectedIndex].text;

	if (city && citys[city_state].indexOf(city) != -1)
		document.getElementById('txtplacename').innerHTML = city + ', ' + city_state;
	else document.getElementById('txtplacename').innerHTML = city_state;
}
