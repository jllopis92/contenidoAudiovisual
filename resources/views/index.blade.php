...
@section('content')
    ...
    border-color: #e7e7e7;">
        ...
        @foreach($visitMovies as $key=>$movie)
			...
			<ul class="col-xs-10 col-xs-offset-1 col-sm-12 col-md-12" id="viewShowInfo{{$key}}" style="display: none; margin-top: 10px;">
				<div id="viewSlideContainer" class="slideContainer">
					<strong class="slideTitle" id="viewSlideTitle{{$key}}"></strong>
					<div class="slideBody" style="text-align: left;">
						<ul>
							<li>
								<div class="messageblock">
        ...
        @foreach($bestMovies as $key=>$movie)
			...
			<ul class="col-xs-10 col-xs-offset-1 col-sm-12 col-md-12" id="bestShowInfo{{$key}}" style="display: none; margin-top: 10px;">
				<div id="bestSlideContainer" class="slideContainer">
					<strong class="slideTitle" id="bestSlideTitle{{$key}}"></strong>
					<div class="slideBody" style="text-align: left;">
						<ul>
							<li>
								<div class="messageblock">
