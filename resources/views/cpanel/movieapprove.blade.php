			...
			@elseif (count($aproves) >= 1)
				...
				<table class="table" data-filtering="true" data-paging="true">
					<thead>
						...
						<th class="blackText">Información</th>
					...
					<tbody>
						@foreach($aproves as $aprove)
							...
							<td data-type="html" style="vertical-align: middle;">
								<div class="btn-group">
									<button type="button" class="btn btn-default footable-edit"></button>
									<button type="button" class="btn btn-default footable-delete" ></button>
								</div>
