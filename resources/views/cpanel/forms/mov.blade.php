...
<div class = "form-group">
    ...
    {!!Form::text('asignatura_id',null,['class'=>'form-control'])!!}
</div>

<div class = "form-group">
    {!! Form::label('category', 'Categoría:') !!}
    {{ Form::select('category', ['largometraje de ficcion' => 'Largometraje de Ficción', 'cortometraje de ficcion' => 'Cortometraje de Ficción', 'animacion' => 'Animación', 'documental' => 'Documental'], null, ['class' => 'form-control']) }}
    {{-- {!!Form::text('category',null,['class'=>'form-control'])!!} --}}
</div>

<div class = "form-group">
    {!! Form::label('shooting_format', 'Formato de Rodaje:') !!}
    {{ Form::select('shooting_format', ['4K' => '4K', '2K' => '2K', 'HD' => 'HD', 'MiniDV' => 'MiniDV'], null, ['class' => 'form-control']) }}
</div>
